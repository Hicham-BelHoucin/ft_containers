...
CXX="clang++"
CXXFLAGS="-Wall -Werror -Wextra -g -std=c++98 -I$FT_CONTAINERS -I."
...
do_test() {
    ...
    if $CXX $CXXFLAGS -DNAMESPACE=ft -DSFINAE=ft -g $3 track/memory_tracker.cpp track/leak_checker.cpp; then
